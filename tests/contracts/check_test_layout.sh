...
for file in \
  tests/fixtures/build_image.h \
  tests/support/test.h \
  tests/unit/projection_error_test.cpp \
  tests/header/public_header_test.cpp \
  tests/integration/source_binding_test.cpp \
  tests/integration/build_provenance_test.cpp \
  tests/integration/image_provenance_test.cpp \
  tests/integration/admission_path_test.cpp \
  tests/integration/identity_sensitivity_test.cpp \
  tests/integration/upstream_refusal_test.cpp \
  tests/integration/value_semantics_test.cpp; do
